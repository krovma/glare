...
static void CheckStacksSize(ImGuiWindow* window, bool write)
{
    ...
    // For color, style and font stacks there is an incentive to use Push/Begin/PollNextJob/.../End patterns, so we relax our checks a little to allow them.
